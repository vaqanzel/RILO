...
if(isset($_GET['idKategoriMenu'])) {
    ...
    $qKategori = mysqli_query($con,"SELECT * FROM kategorimenu WHERE idKategoriMenu ='$id'");
    $u = mysqli_fetch_array($qKategori);
}
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <form role="form" action="data.php" class="text-start" method="POST">
                                        <div class="input-group input-group-outline mb-3">
                                            <label class="form-label"></label>
                                            <input type="text" class="form-control" name="idKategoriMenu" value="<?php echo isset($u['idKategoriMenu']) ? $u['idKategoriMenu'] : ''; ?>" autofocus>
                                        </div>
                                        <div class="input-group input-group-outline mb-3">
                                            <label class="form-label"></label>
                                            <input type="text" class="form-control" name="namaKategori" value="<?php echo $u['namaKategori']; ?>" autofocus>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" name="UpKategori"  style="background-color : #AF06B8" class="btn float-end text-white me-1" ><i class="bi-save"></i>Simpan</button>
                                            <button type="button" class="btn btn-danger float-end" data-bs-dismiss="modal"><i class="bi-x-circle"></i> Batal</button>
                                        </div>
                                      </form>
                                      </div>
                                ...
                                <table class="table mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="kategorimenu.php?idKategoriMenu=<?php echo $u['idKategoriMenu']; ?>" data-bs-toggle="modal" data-bs-target="#updateModal"> Edit</a> </td>
