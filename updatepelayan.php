...
if(isset($_GET['idPelayan'])) {
   $id = $_GET['idPelayan'];
$qPelayan = mysqli_query($con,"SELECT * FROM pelayan");
    ...
    <div class="container-fluid">
        ...
        <form action="data.php" method="POST" >
                ...
                <div class="input-group input-group-outline mb-3">
                  ...
                  <input type="text" name="idPelayan" id="" class="form-control" placeholder="" value="<?= $recPelayan['idPelayan'] ?>">
              </div>   
                <div class="input-group input-group-outline mb-3">
                  <label class="form-label"></label>
                  <input type="text" name="nama" id="" class="form-control" placeholder="" value="<?= $recPelayan['nama'] ?>">
                </div>
                <div class="input-group input-group-outline mb-3">
                  <label class="form-label"></label>
                  <input type="text" name="alamat" id="" class="form-control" placeholder="" value="<?= $recPelayan['alamat'] ?>">
                </div>
                <div class="input-group input-group-outline mb-3">
                  <label class="form-label"></label>
                  <input type="text" name="noTelp" id="" class="form-control" placeholder="" value="<?= $recPelayan['noTelp'] ?>">
                </div>
                <input type="hidden" name="idPelayan" value="<?= $recPelayan['idPelayan'] ?>" />

                <input type="submit" style="background-color : #4F06B8;" class="btn float-end text-white" name="UpPelayan" value="Update Pelayan" >
                </form>
            </div>
        </div>
    </div>
